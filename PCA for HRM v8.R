...
##C.1 make absolute fluorescence into percentage
...
###C.3 make absolute fluorescence into percentage
...
###C.4 make the median curve
medcurve <- apply(normfluor, 1, median)

###C.5 use median curve to normalize percentage melt curves
